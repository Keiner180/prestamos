            ...
            <div class="contenedorPadre">
                <div class="opciones">
                    ...
                    <a class="opcion activo cursor" href="<?php echo SERVERURL ?>adminFinalizado/"><span class="material-symbols-sharp"> receipt_long</span>FINALIZADOS</a>
                    <a class="opcion" href="<?php echo SERVERURL ?>adminSearchDate/"><span class="material-symbols-sharp"> search_check</span>BUSCAR USUARIO</a>
                ...
                <div class="formularioContenedor">
                    ...
                    echo $insPrestamo->paginadorPrestamosControlador($url[1], 8, $url[0], "Finalizado",  "", "");
                    ?>
