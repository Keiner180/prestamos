...
if (isset($_GET["views"])) {
    ...
    if (isset($url[1])) {
        ...
        $ins_datos = new loginController();
        $datos = $ins_datos->seleccionarDatosCampos("UnicoFactura", "usuario", "usuario_dni", $id,"");
    }
}
...
?>
        ...
        <div class="wrapper2">
            <section class="chat-area">
                <header>
                    ...
                    <?php if (is_file("./views/assets/img/admin/" . $datos["usuario_foto"])) { ?>
                        <img src="<?php echo SERVERURL ?>app/views/assets/img/admin/fotoUser/<?php echo $datos["usuario_foto"] ?> ">

                    <?php } else { ?>
                        <img src="<?php echo SERVERURL ?>./views/assets/img/admin/defecto.png">
                    <?php } ?>
                    <div class="details">
                        <span><?php echo $datos['usuario_nombre'] . " " . $datos['usuario_apellido'] ?></span>
                        <p><?php echo $datos['usuario_estado']; ?></p>
                    </div>
                </header>
                <div class="chat-box">
    ...
    <script src="<?php echo SERVERURL ?>views/js/admin/chat.js"></script>
...
<?php } else { ?>
    ...
    <div class="container-404 container-403">
        <div class="img404">
            <img src="<?php echo SERVERURL ?>views/assets/img/admin/404.png" alt="404">
        </div>
        <div class="text-boton">
            <h2>¡USUARIO NO ENCONTRADO!</h2> <!-- Título actualizado -->
            <span class="loaderlibro"></span>
            <p>No se pudo encontrar el usuario para chatear. Es posible que el usuario no exista o hayas modificado la url.</p> 
