...
$vistas = $IV->obtenerVistaControlador();

if ($vistas === "login" || $vistas === "404") {
    require_once("./views/admin/" . $vistas . "-view.php");
} else {
    require_once("./controller/loginController.php");
    $lc = new loginController();

    if (!isset($_SESSION["token_spm"]) || !isset($_SESSION["id_spm"]) || !isset($_SESSION["nombre_spm"]) || !isset($_SESSION["usuario_spm"])  || !isset($_SESSION["privilegio_spm"])  || !isset($_SESSION["apellido_spm"])) {
...
?>
    ...
    <body class="overflow">
        <main class="main">
            <!-- Menú lateral -->
            <?php require_once("./views/inc/admin/menuLateral.php") ?>


            <!-- Contenido derecho -->
            <?php
            require_once("./views/inc/admin/barra.php");
            require_once($vistas);
            ?>
        </main>
    ...
    require_once("./views/inc/admin/script.php");
    require_once("./views/inc/admin/cerrarSesion.php");
    ?>
